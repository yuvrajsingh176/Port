        ...
        <div className="row">
            <div className="about-desc" >
                ...
                <p >Hi Everyone, I am Yuvraj Singh from Jeetpur, Nepal.<br></br>
                        ...
                        <ul style={{ color: 'white' ,listStyleType:"none",marginTop:"20px",fontSize:"1.2rem"}}>
                        <li><span><BiSolidHandRight/></span>Cricket</li>
                        <li><span><BiSolidHandRight/></span>Gaming</li>
                        <li><span><BiSolidHandRight/></span>Reading Books</li>
...
<img src={gifi}  style={{border:"none" , borderRadius:"50px",width:"90%",height:"90%"}}/>
            ...
            <h1 className='heading' style={{fontWeight:"bold"}} >Professional <strong className='purple text-color' style={{color:hoverColor,fontWeight:"bold"}}>Skillset</strong></h1>
            </div>
            <div className="tech-icons-mainn" >
                <a className="tech-icons cpp" href="https://docs.google.com/document/d/1YSSYaAF1XRPTKdh4-0_VvW1QNJ5GG4Dww4iV4A_H3Eg/edit?usp=sharing">
                ...
                ><svg stroke="currentColor" fill="blue" stroke-width="0" viewBox="0 0 24 24" height="4em" width="4em" xmlns="http://www.w3.org/2000/svg">
                    <path className='hover-fill' d="M12.207 16.278C11.1241 17.343 9.63879 18 8 18C4.68629 18 2 15.3137 2 12C2 8.68629 4.68629 6 8 6C9.67492 6 11.1896 6.6863 12.278 7.79303L13.6923 6.37878C12.2418 4.91014 10.2272 4 8 4C3.58172 4 0 7.58172 0 12C0 16.4183 3.58172 20 8 20C10.1911 20 12.1764 19.1192 13.6212 17.6923L12.207 16.278Z" fill="white"></path>
                    <path className='hover-fill' d="M15 9H13V11H11V13H13V15H15V13H17V11H15V9Z" fill="white"></path>
                        <path className='hover-fill' d="M20 9H22V11H24V13H22V15H20V13H18V11H20V9Z" fill="white"></path></svg>
                </div>
                </a>

           <a className="tech-icons react" href="https://docs.google.com/document/d/1CTVE88FhEqG-0olWhQeWwNihptOBmmHOvSSraBcShAI/edit?usp=sharing">
                <div  onMouseEnter={() => {
                onHoverColor("#00D8FF");
            }}
                onMouseLeave={() => {
        ...
        <a href="" className="tech-icons mongodb">
            ...
            ><svg stroke="currentColor" fill="white" stroke-width="0" role="img" viewBox="0 0 24 24" height="4em" width="4em" xmlns="http://www.w3.org/2000/svg"><title></title><path d="M3.89 15.672L6.255.461A.542.542 0 017.27.288l2.543 4.771zm16.794 3.692l-2.25-14a.54.54 0 00-.919-.295L3.316 19.365l7.856 4.427a1.621 1.621 0 001.588 0zM14.3 7.147l-1.82-3.482a.542.542 0 00-.96 0L3.53 17.984z"></path></svg></div>
            </a>
