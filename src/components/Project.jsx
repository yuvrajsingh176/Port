...
const Project = () => {
  ...
  const desc = [
    "MERN application, companies could list job openings, monitor job statuses, make edits to job postings, and track application statuses, which could have helped the Job seekers in this Competitive market.",
            ...
            <div style={{ margin: "1rem" }}>
              ...
              <div className="onlinebtn">
                <div className="buttonss">
                  <a href="https://github.com/yuvrajsingh176/Jobfolio">
                    {" "}
                    <button>
                      {" "}
                      <FaGithubAlt /> Github
